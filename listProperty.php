...
<style>
	...
	<?php if(!isset($_SESSION['basic-uploaded'])){ ?>
	...
	<div class="list-property-left">
		...
		<form class="list-property-form" action="" method="post" enctype="multipart/form-data">
		  ...
		  <input type="radio" name="uploader-type" id="radio" value="Owner">
			...
			<div class="form-name">
			<input type="text" name="p-name" id="f-name" placeholder="Name">
...
`				<br>
			...
			<?php if(isset($_SESSION["loggedin"])){ ?>
				<input type="submit" name="upload" id="list-prop-upload" value="Continue">
			<?php } ?>
		</form>
		<?php if(!isset($_SESSION["loggedin"])){ ?>
...
<div class="list-property-left">
	<form class="list-property-form" action="" method="post">
		<div class="list-personal-details">
			...
			Property Title: <br>
			<input type="text" name="" id="" placeholder="e.g. 3 BHK Independent House, 5 BHK Bungalow etc.... ">

			<br>
			<b>Property Confugrations</b><br><br>
			Build-up Area: <br>
			<input type="text" name="" id="" placeholder="Build-up Area Value">
			Configuration: <br>
			<input type="text" name="" id="" placeholder="eg. 3 BHK, 5BHK etc.">
			Possession Status: <br>
			<input type="text" name="" id="" placeholder="eg. 31st Jan, 2002">
			<br>
			Facing: <br>
			<input type="text" name="" id="" placeholder="eg. East">
			<br>
			Carpet Area: <br>
			<input type="text" name="" id="" placeholder="eg. 1120 ft">
			Bathrooms: <br>
			<input type="text" name="" id="" placeholder="eg. 3 BHK, 5BHK etc.">
			Balcony: <br>
			<input type="text" name="" id="" placeholder="eg. 3 BHK, 5BHK etc.">
			...
			<br>
			<br>
			<input type="submit" name="list-continue-2" id="l-cont-2" value="Continue →">
		</form>
		</div>
	</div>
<img src="images/real-estate5.png" alt="" width="100%" height="400px">
